...
#define INTERVAL_TEXT_LEFT_MARGIN 5.0
#define INTERVAL_TEXT_MAX_WIDTH 100.0

#define gridPadding 40.0
...
- (void)drawRect:(CGRect)rect {
  ...
  CGPoint startPoint = CGPointMake(gridPadding,CGRectGetHeight([self frame]) - BOTTOM_PADDING);
  CGPoint endPoint = CGPointMake(CGRectGetMaxX(rect), CGRectGetHeight([self frame])-BOTTOM_PADDING);
  ...
  for(NSUInteger i = 0;i<numberOfIntervalLines-1;i++){
    ...
    [paragraphStyle setLineBreakMode:NSLineBreakByTruncatingTail];
      ...
      CGFloat halfLineHeight = [[self.chartContainer gridIntervalFont] lineHeight]/2;
      
    [stringToDraw drawInRect:CGRectMake(INTERVAL_TEXT_LEFT_MARGIN,
                                        (CGRectGetHeight([self frame]) - halfLineHeight - BOTTOM_PADDING),
